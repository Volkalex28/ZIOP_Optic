...
void screenShsn(void)
{
  ...
  Screens->Shsn.Settings.Event.Vv1_220_inW = I10;
  Screens->Shsn.Settings.Event.Vv2_220_inW = I11;
  Screens->Shsn.Settings.Event.Vv1_36_inW  = I12;
  Screens->Shsn.Settings.Event.Vv2_36_inW  = I13;

  Screens->Shsn.Settings.Event.Vv1_220_offA = I2;
  Screens->Shsn.Settings.Event.Vv2_220_offA = I4;
  Screens->Shsn.Settings.Event.Vv1_36_offA  = I3;
  Screens->Shsn.Settings.Event.Vv2_36_offA  = I5;
  ...
  switch (Screens->Shsn.Settings.Event.Choose)
  {
      case 0: strcpy(Screens->Shsn.Settings.TitleChoose, "ШСН");    break;
      case 1: strcpy(Screens->Shsn.Settings.TitleChoose, "ШСН-Д");  break;
  }
}